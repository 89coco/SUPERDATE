...
bane = Super.create!(user: david, super_name: "bane", super_type: "hero", universe: "DC", availability: false, price: 1800, description: "Bane is a supervillain possessing a mix of brute strength and exceptional intelligence, Bane is often credited as the only villain to have broken the bat; defeating him both physically and mentally.", strength: 2, humour: 5 , kindness: 2 , romance: 3)
